            ...
            class ContentService {
                ...
                getServerParams() {
                    ...
                    var params = {
                        ...
                        'due.from': wfFormatDateTimeFilter(wfDateParser.fromDate(dateRange['from']), "ISO8601") || null,
                        'due.until': wfFormatDateTimeFilter(dateRange['until'], "ISO8601") || null,
                        'created.from': wfFormatDateTimeFilter(wfDateParser.fromDate(createdRange['from']), "ISO8601") || null,
                        'created.until': wfFormatDateTimeFilter(createdRange['until'], "ISO8601") || null,
                        'view.from': wfFormatDateTimeFilter(wfDateParser.fromDate(viewRange['from']), "ISO8601") || null,
