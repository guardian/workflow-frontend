...
/**
 * Poll the workflow api for plan items
 *
 * @param http
 * @param planService
 * @param PollingService
 * @param wfFiltersService
 * @param $rootScope
 */
function wfPlanLoader (planService, PollingService, wfFiltersService, $rootScope) {
...
/**
 * Main Controller for the plan view. Fetches items and marshalls events across directives
 *
 * @param $scope
 * @param $rootScope
 * @param planLoader
 * @param $http
 * @param $timeout
 * @param wfDayNoteService
 * @param wfFiltersService
 * @param wfPlannedItemService
 */
