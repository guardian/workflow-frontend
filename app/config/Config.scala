...
object Config extends AwsInstanceTags {
  ...
  private lazy val snippetAtomTypes: List[String] = List("guide", "qanda", "timeline", "profile")
  lazy val atomTypes: List[String] = List("media", "storyquestions") ++ snippetAtomTypes
