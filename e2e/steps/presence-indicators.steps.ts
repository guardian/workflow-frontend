...
import type { PersonWithLocation } from "./fixtures";
...
function getPeople(world: Record<string, unknown>): PersonWithLocation[] {
    return (world.people as PersonWithLocation[] | undefined) ?? [];
}
